...
#define REG_CSD                 ((volatile UInt16  *)(0xFFFFF116))
#define REG_CS_RO_BIT           0x2000
...
/*--------------------------------------------------------------------------
 * Set/reset RAM write protection
 *--------------------------------------------------------------------------*/
void HDWUnwriteProtectRAM(void)
{
    *REG_CSD &= ~REG_CS_RO_BIT;
}

void HDWWriteProtectRAM(void)
{
    *REG_CSD |= REG_CS_RO_BIT;
}
