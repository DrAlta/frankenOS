...
*				ScanGetBarTypeS...// Get the barCode type string from resource.
*
 ...
 *
 * DESCRIPTION: Gets a string out of a string list resource based on
 *              the barType passed in.
 *
 * PARAMETERS:  barType(in) - The type of barcode.
 *					 pszBarType(out) - Pointer to string that will be copied.
